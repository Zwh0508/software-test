...
public class TestLab2 {
	  ...
	  public void testLab2() throws Exception {
	    ...
	    for(int i=0;i<143;i++) {
	    	...
	    	WebElement welement = driver.findElement(By.name("id"));
	        welement.click();
	        driver.findElement(By.name("id")).clear();
	        driver.findElement(By.name("id")).sendKeys(sid_now);
	        WebElement welement2 = driver.findElement(By.name("password"));
	        welement2.click();
	        driver.findElement(By.name("password")).clear();
	        driver.findElement(By.name("password")).sendKeys(spassword_now);
	        driver.findElement(By.id("btn_login")).click();
	        assertEquals(sid_now, driver.findElement(By.id("student-id")).getText());
	        ...
	        WebElement welement3 = driver.findElement(By.id("btn_logout"));
	        welement3.click();
	        WebElement welement4 = driver.findElement(By.id("btn_return"));
	        welement4.click();
	      }
	    }
